...
{
    public override StateId Id => StateId.Select;
    ...
    public class IdleState : StateNode
    {
        ...
        public override void OnPointerDown(PointerEvent e)
        {
            ...
            if (arrowEndpoint.HasValue)
            {
                ...
                Parent?.Transition(StateId.ArrowEditing);
                return;
            }
            ...
            if (Editor.Selection.Count > 0)
            {
                ...
                if (handle == SelectionManager.HandleType.Rotation)
                {
                    ...
                    Parent?.Transition(StateId.Rotating);
                    return;
                }
                ...
                if (handle != SelectionManager.HandleType.None)
                {
                    ...
                    Parent?.Transition(StateId.Resizing);
                    return;
                }
            }
            ...
            if (hitShape != null)
            {
                ...
                Parent?.Transition(StateId.Pointing);
            }
            else
            {
                ...
                _tool.PointerStartWorld = new SKPointd(e.WorldX, e.WorldY);
                _tool.PointerStartScreen = new SKPoint((float)e.ScreenX, (float)e.ScreenY);
                Parent?.Transition(StateId.Brush);
            }
    ...
    public class PointingState : StateNode
    {
        ...
        public override StateId Id => StateId.Pointing;
        ...
        public override void OnPointerMove(PointerEvent e)
        {
            ...
            if (dist > DragThreshold)
            {
                ...
                Parent?.Transition(StateId.Dragging);
            }
        }
    ...
    public class DraggingState : StateNode
    {
        ...
        public override StateId Id => StateId.Dragging;
    ...
    public class BrushState : StateNode
    {
        ...
        public override StateId Id => StateId.Brush;
    ...
    {
        private readonly SelectTool _tool;
        public override StateId Id => StateId.Resizing;
    ...
    {
        private readonly SelectTool _tool;
        public override StateId Id => StateId.Rotating;
    ...
    {
        private readonly SelectTool _tool;
        public override StateId Id => StateId.ArrowEditing;
    ...
    internal void SaveShapeBounds(InkCanvas.Core.Editor.Editor editor)
    {
    ...
    internal void SaveRotationStart(InkCanvas.Core.Editor.Editor editor)
    {
