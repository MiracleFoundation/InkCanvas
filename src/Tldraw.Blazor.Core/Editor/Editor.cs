...
public class Editor
{
    ...
    private readonly Dictionary<string, StateNode> _tools = new();
    ...
    public StateNode? GetTool(string toolId) =>
    ...
    private void DrawHud(SKCanvas canvas, int width, int height)
    {
        ...
        canvas.DrawText($"Tool: {ActiveTool.Id}", 8, height - 44, SKTextAlign.Left, font, paint);
    }
}
